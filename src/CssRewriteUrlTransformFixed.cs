    ...
    public class CssRewriteUrlTransformFixed : IItemTransform
    {
        private static string RebaseUrlToAbsolute(string baseUrl, string url, string prefix, string suffix)
        {
            ...
            if (url.StartsWith("data:"))
            {
                ...
                return Convert.ToString(prefix + url) + suffix;
            }
        ...
        private static string ConvertUrlsToAbsolute(string baseUrl, string content)
        {
            ...
            return regex.Replace(content, (Match match) => (Convert.ToString("url(") + CssRewriteUrlTransformFixed.RebaseUrlToAbsolute(baseUrl, match.Groups["url"].Value, match.Groups["prefix"].Value, match.Groups["suffix"].Value)) + ")");
        }
        public string Process(string includedVirtualPath, string input)
        {
            ...
            dynamic directory = VirtualPathUtility.GetDirectory(includedVirtualPath);
